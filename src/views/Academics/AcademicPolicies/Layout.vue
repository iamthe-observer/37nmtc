<template>
  <div class="p-4 w-full relative text-center">
    <h1 class="text-[3em] font-Bebas_Neue mt-16 mb-20">Academic Regulations</h1>
    ...
    <div class="flex-col flex gap-8">
      ...
      <Fieldset class="pb-8 shadow-lg" :toggleable="true" :collapsed="true"
        ...
        <div class="text-left">
          <p>
            A student's cumulative grade point average is calculated by dividing
            the total number of grade points obtained up to any specified time
            by the total number of credits for all courses for which the student
            has registered up to that time. This is calculated at the end of
            each academic year.
          </p>
        </div>
      </Fieldset>
      ...
      <Fieldset class="pb-8 shadow-lg" :toggleable="true" :collapsed="true"
        ...
        <div class="text-left">
          <p>
            ...
            request and payment of the prescribed fee. Such transcripts shall be
            sent only to the requesting institutions. Transcripts shall reflect
            the grades of all courses taken including failed and re-sits.
          </p>
        </div>
      </Fieldset>
      ...
      <Fieldset class="pb-8 shadow-lg" :toggleable="true" :collapsed="true"
        ...
        <div class="text-left">
          <p>
            The academic committee will consider external examiner's reports and
            approve all examination results. Results of the semester shall
            normally be published before the commencement of the next semester.
            A result slip indicating the student's performance in the
            examination shall be made available to the students.
          </p>
        </div>
      </Fieldset>
      ...
      <Fieldset class="pb-8 shadow-lg" :toggleable="true" :collapsed="true"
        ...
        <div class="text-left">
          <p>
            ...
            conducted at a prescribed fee determined by the academic committee.
          </p>
        </div>
      </Fieldset>
        ...
        <div class="text-left">
          <ol class="list-disc pl-10">
            <li>
              ...
              referred in those courses. He/she shall rewrite the referred paper
              in a supplementary exam.
            </li>
            <li>
      ...
      <Fieldset class="pb-8 shadow-lg" :toggleable="true" :collapsed="true"
        ...
        <div class="text-left">
          <ol class="list-disc pl-10">
            ...
            <li>
              At the end of the period of repetition, the student must obtain at
              least a CGPA of 20 or better and may trail in only one course in
              order to move forward to the next academic year.
            </li>
            <li>
      ...
      <Fieldset class="pb-8 shadow-lg" :toggleable="true" :collapsed="true"
        ...
        <p>
          ...
          absents himself/herself from lectures or clinical work for cumulative
          21 days in a semester will be disqualified to write that semester's
          examinations. He/she shall repeat that semester. If for medical
          reasons, a student cannot meet the above requirement he/she shall be
          advised to withdraw voluntarily from the programme through due
          process. To get approval for voluntary withdrawal, the student must
          submit a medical report certified by a recognized medical doctor.
        </p>
      </Fieldset>
      ...
      <Fieldset class="pb-8 shadow-lg" :toggleable="true" :collapsed="true"
        ...
        <p>
          ...
          examinations. Students cannot be permitted to enter for the licensing
          examination if they have referred papers to write. Candidates with 3
          or more referred papers need ample time to learn to pass their
          examinations and may not be permitted to enter for the examination
          when the academic committee considers it not appropriate. They may
          have to join the regular classes for 2nd year or 3rd year depending on
          the papers affected. Such a candidate will be allowed to enter during
          the next available examination period as accepted by the NMC.
        </p>
      </Fieldset>

      <Fieldset class="pb-8 shadow-lg" :toggleable="true" :collapsed="true"
        ><template #legend>Re-opening Date</template>
        <p>All students should report on the set date.</p>
      </Fieldset>
      ...
      <Fieldset class="pb-8 shadow-lg" :toggleable="true" :collapsed="true"
        ...
        <div class="text-left">
          <ol class="list-disc pl-10">
            <li>
              Registration of course shall begin from the first (1") week of the
              semester and close by the end of the second (2") week.
            </li>
            <li>
      ...
      <Fieldset class="pb-8 shadow-lg" :toggleable="true" :collapsed="true"
        ...
        <div class="text-left">
          <ol class="list-disc pl-10">
            <li>
              Written and Practical Examination will be conducted at the end of
              each semester. Students must obtain passes in all course offered
              to qualify for the completion of the diploma programme.
            </li>
            <li>
              A student shall be required to write and pass an examination
              conducted by the affiliated institution (KNUST) to qualify for the
              diploma certificate.
            </li>
            <li>
              ...
              complete the programmes. This will make the students eligible for
              the NMC Licensure Examination after which he/she undertakes one
              year internship (Rotation).
            </li>
          </ol>
        </div>
      </Fieldset>
      ...
      <Fieldset class="pb-8 shadow-lg" :toggleable="true" :collapsed="true"
        ...
        <p>
          A student is considered not to have completed the diploma programme if
          he/she has an outstanding examination and resits to be done, a
      ...
      <Fieldset class="pb-8 shadow-lg" :toggleable="true" :collapsed="true"
        ...
        <p>
          ...
          apply to the principal who shall refer the application to the Academic
          Committee for advice. Application for deferment would normally not be
          entertained after eight (8) weeks into the semester. Deferment shall
          be a maximum of 4 semesters after which one has to reapply as a fresh
          applicant.
        </p>
      </Fieldset>
        ...
        <div class="text-left">
          <ol class="list-disc pl-10">
            <li>
              ...
              upon provision of a medical certificate be allowed to take them at
              the examination.
            </li>
            <li>
              <span class="text-primaryclr font-bold"
              ...
              shall be the student's responsibility to satisfy the school beyond
              reasonable doubt why he/she wishes to defer the examination. The
              application must be submitted not later than two weeks before the
