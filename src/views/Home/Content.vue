    ...
    >
      ...
      >
        <div
          ...
          :key="i"
          class="card w-96 border-me shadow-xl rounded-none hover:box-box hover:translate-y-[-10px] hover:bg-secondaryclr transition-all duration-300 ease-out hover:text-white"
        >
          <figure>
      ...
      <Footer />
      <!-- <ScrollTop class="custom-scrolltop box-box" target="parent" /> -->
    </div>
  </div>
</template>
